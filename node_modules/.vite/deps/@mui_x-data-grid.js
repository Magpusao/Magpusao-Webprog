...
var require_use_sync_external_store_shim_development = __commonJS({
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim.development.js"(exports) {
    ...
    (function() {
      ...
      var React155 = require_react(), objectIs = "function" === typeof Object.is ? Object.is : is2, useState25 = React155.useState, useEffect44 = React155.useEffect, useLayoutEffect7 = React155.useLayoutEffect, useDebugValue = React155.useDebugValue, didWarnOld18Alpha = false, didWarnUncachedGetSnapshot = false, shim = "undefined" === typeof window || "undefined" === typeof window.document || "undefined" === typeof window.document.createElement ? useSyncExternalStore$1 : useSyncExternalStore$2;
...
var gridExistingPinnedColumnSelector = createSelectorMemoized(gridPinnedColumnsSelector, gridColumnFieldsSelector, gridIsRtlSelector, (model, orderedFields, isRtl) => filterMissingColumns(model, orderedFields, isRtl));
...
function GridScrollAreaWrapper(props) {
  const apiRef = useGridApiContext();
  const [dragDirection, setDragDirection] = React31.useState("none");
  ...
  if (dragDirection === "horizontal") {
    return (0, import_jsx_runtime17.jsx)(GridHorizontalScrollAreaContent, _extends({}, props));
  }
  return (0, import_jsx_runtime17.jsx)(GridVerticalScrollAreaContent, _extends({}, props));
}
...
var SearchInput = styled_default(TextField_default, {
  name: "MuiDataGrid",
...
var useGridPipeProcessing = (apiRef) => {
  ...
  const registerPipeProcessor = React108.useCallback((group, id, processor) => {
    ...
    if (oldProcessor !== processor) {
      ...
      groupCache.processorsAsArray = Array.from(cache2.current[group].processors.values()).filter((processorValue) => processorValue !== null);
      runAppliers(groupCache);
    }
    return () => {
      cache2.current[group].processors.set(id, null);
      cache2.current[group].processorsAsArray = Array.from(cache2.current[group].processors.values()).filter((processorValue) => processorValue !== null);
    };
  }, [runAppliers]);
...
function useGridDimensions(apiRef, props) {
  ...
  const scrollYOscillation = React138.useRef({
    counter: 0,
    heights: {
      content: 0,
      pinnedTop: 0,
