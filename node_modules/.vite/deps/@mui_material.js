  ...
  return (0, import_jsx_runtime84.jsxs)(RootSlot, _extends({}, rootProps, {
    children: [(0, import_jsx_runtime83.jsx)(RailSlot, _extends({}, railProps)), (0, import_jsx_runtime83.jsx)(TrackSlot, _extends({}, trackProps)), marks.filter((mark) => mark.value >= min && mark.value <= max).map((mark, index) => {
      ...
      return (
        ...
        (0, import_jsx_runtime83.jsx)(ValueLabelComponent, _extends({}, !isHostComponent_default(ValueLabelComponent) && {
          valueLabelFormat,
          valueLabelDisplay,
...
var Step = React86.forwardRef(function Step2(inProps, ref) {
  ...
  return (0, import_jsx_runtime97.jsx)(StepContext_default.Provider, {
    value: contextValue,
    children: connector && !alternativeLabel && index !== 0 ? (0, import_jsx_runtime96.jsxs)(React86.Fragment, {
...
var StepButton = React91.forwardRef(function StepButton2(inProps, ref) {
  ...
  const child = isMuiElement_default(children, ["StepLabel"]) ? React91.cloneElement(children, childProps) : (0, import_jsx_runtime104.jsx)(StepLabel_default, _extends({}, childProps, {
    children
  }));
...
var SwipeableDrawer = React96.forwardRef(function SwipeableDrawer2(inProps, ref) {
  ...
  return (0, import_jsx_runtime110.jsxs)(React96.Fragment, {
    children: [(0, import_jsx_runtime109.jsx)(Drawer_default, _extends({
      ...
      onClose,
      ref
    }, other)), !disableSwipeToOpen && variant === "temporary" && (0, import_jsx_runtime109.jsx)(NoSsr_default, {
...
var Tab = React98.forwardRef(function Tab2(inProps, ref) {
  ...
  return (0, import_jsx_runtime113.jsxs)(TabRoot, _extends({
    ...
    children: [iconPosition === "top" || iconPosition === "start" ? (0, import_jsx_runtime113.jsxs)(React98.Fragment, {
      children: [icon, label]
