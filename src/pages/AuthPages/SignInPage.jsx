  ...
  return (
    <section>
      ...
      <p className="mt-3 text-sm leading-6 text-zinc-600">
        Access your account using the same monochrome wireframe language used across this site.
      </p>
      ...
      <form className="mt-8 space-y-5">
        ...
        <div className="flex items-center justify-between gap-4 text-sm">
          ...
          <button type="button" className="font-semibold text-zinc-900 transition hover:text-green-700">
            Forgot Password?
          </button>
        </div>
      ...
      <div className="mt-8 border-t border-zinc-200 pt-6 text-sm text-zinc-600">
        No account yet?{' '}
        <Link to="/auth/signup" className="font-semibold text-zinc-900 transition hover:text-green-700">
          Sign up
        </Link>
      </div>
    </section>
